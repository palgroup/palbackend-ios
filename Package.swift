...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.16.0/Palbe.xcframework.zip",
            checksum: "bca6ad1eca3583e19a9c55c39bb3b095b4443f1502edaf96c72b9c62798b4325"
        ),
    ],
