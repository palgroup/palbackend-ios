...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.6.0/Palbe.xcframework.zip",
            checksum: "9c810e8ae59cfeb6d1b746122ce93950d307a1dad1277cb7778fd317af27004d"
        ),
    ],
