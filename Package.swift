...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.19.0/Palbe.xcframework.zip",
            checksum: "8a2df4172ff472a80d84eb8010c3fbbef9ab3352ef096db7da76af2d8686a128"
        ),
    ],
