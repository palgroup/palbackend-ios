...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.12.1/Palbe.xcframework.zip",
            checksum: "cff42f782cb8e6ac88999eafbe1b7d9cbc26f850197ec81c04aff0dbfda33854"
        ),
    ],
