...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.19.1/Palbe.xcframework.zip",
            checksum: "88b531cf6ba85b3b85a9c517df36ebfd0e0e8a8e41435d2cda6cecce3e74cb83"
        ),
    ],
