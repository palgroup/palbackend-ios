...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.7.1/Palbe.xcframework.zip",
            checksum: "45b4f614e2b14785e0908bd35eba173051154d883b8762183ad6a19e7bef3a37"
        ),
    ],
