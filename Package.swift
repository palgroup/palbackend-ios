...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.9.1/Palbe.xcframework.zip",
            checksum: "d72c5bfb8191fbeff30438ebf4c33780af9e4dc3b955a529dd63a6b7d0c8fc74"
        ),
    ],
