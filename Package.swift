...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.10.1/Palbe.xcframework.zip",
            checksum: "fbdcc19ae8c0fed50b6bfe953f89f09a3ecfdc836b8826dd36587248a0958b2c"
        ),
    ],
