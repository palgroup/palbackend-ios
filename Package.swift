...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.9.8/Palbe.xcframework.zip",
            checksum: "cab4f6147e83687d78a50fa82cfee153b42b119062f5edb449f9adc2459c1655"
        ),
    ],
