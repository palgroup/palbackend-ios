...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.9.5/Palbe.xcframework.zip",
            checksum: "bc7ed23ce0bb541c0ff43823f4b51cf215acbc04ba8fcdab6a27bacbf171d5d1"
        ),
    ],
