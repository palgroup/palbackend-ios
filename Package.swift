...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.16.1/Palbe.xcframework.zip",
            checksum: "112b74649b0b9ddb22f14ae71d8f869a5b35a9e47997aa09b0b17d48cdc304b3"
        ),
    ],
