...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.5.5/Palbe.xcframework.zip",
            checksum: "92465497f35ab54cc8f2b48e2f0f093f98873a184390dcd7bf9593c3fb470c6f"
        ),
    ],
