...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.5.8/Palbe.xcframework.zip",
            checksum: "afaebfdbc4cb31d66a13be636915ea08568c12bbe4cb17fe77f89f5bf0751fa4"
        ),
    ],
