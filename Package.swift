...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.2.13/Palbe.xcframework.zip",
            checksum: "45320d38f920a338a687862451716f3b49980d222e3900420c484fe3f9b54e3b"
        ),
    ],
