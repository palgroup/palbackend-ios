...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.5.4/Palbe.xcframework.zip",
            checksum: "3bd75e94798fbeedbd2cbd18af7a5a3db73ad2e6a60f2ea6699af78944601142"
        ),
    ],
