...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.9.0/Palbe.xcframework.zip",
            checksum: "e5f3e032ee3a1b7e5a038843be1bcaacbdc15afdf4522091f64270cae0465c5c"
        ),
    ],
