...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.8.5/Palbe.xcframework.zip",
            checksum: "fc6d797811f69a2fbf02e98b633bc11507bbbcd25b824903898a986bd374b097"
        ),
    ],
