...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.8.7/Palbe.xcframework.zip",
            checksum: "809feea221fd9e14b8f184475d4534d5da40cb0669919e0866690cc91a512733"
        ),
    ],
