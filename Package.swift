...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.8.0/Palbe.xcframework.zip",
            checksum: "7dd71d201a331ce615de991c1c29044727dfcd3d22c6cab878ecddf207e705c0"
        ),
    ],
