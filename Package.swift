...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.4.1/Palbe.xcframework.zip",
            checksum: "e3e1176dde854090001ae5aa1ddf705301d1a8205ccca1fb7c65c7b4efa3ee0e"
        ),
    ],
