...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.14.0/Palbe.xcframework.zip",
            checksum: "a77582680b50450d90093964e376c682019d44ee1e5652fd88f6e135bfc8b2aa"
        ),
    ],
