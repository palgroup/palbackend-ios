...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.17.0/Palbe.xcframework.zip",
            checksum: "176e9471065dbba2e2db7a017769774b0bc6ec26a19bbeaba32776fdb9da1315"
        ),
    ],
