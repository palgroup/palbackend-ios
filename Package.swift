...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.11.0/Palbe.xcframework.zip",
            checksum: "25c2114fd1dd98e59f89b5cd947de6b43c5517f781267626d0cd6201b6d1df22"
        ),
    ],
