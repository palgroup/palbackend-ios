...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.2.12/Palbe.xcframework.zip",
            checksum: "860a2f93e586125db1f69e27175e50b9704dfc7ff99e70deda5d09d10768d01c"
        ),
    ],
