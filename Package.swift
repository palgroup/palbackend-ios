...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.4.0/Palbe.xcframework.zip",
            checksum: "005e284b201959932d8559d3749c4a745fd90b82f613990288caac60e311d7fe"
        ),
    ],
