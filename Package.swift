...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.1.0/Palbe.xcframework.zip",
            checksum: "a2796dc160aa741c75e8dd349232fa939e75e64dfc0abae3ec321cc9d8f4435d"
        ),
