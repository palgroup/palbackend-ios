...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.2.9/Palbe.xcframework.zip",
            checksum: "43906243d798c46472eff266e55087c238d2922fadf47799e98aeaf716235104"
        ),
    ],
