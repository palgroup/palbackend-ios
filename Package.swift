...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.9.4/Palbe.xcframework.zip",
            checksum: "6ed523fb5f637bccfbc30704a3aac899f69cfcae7dab7efc2444b9448223d8a3"
        ),
    ],
