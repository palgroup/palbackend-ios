...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.2.11/Palbe.xcframework.zip",
            checksum: "f3e7b192ff304c3dbe360b016c1d8ba7cc0cb0e34f9a665e1582dee9d0e7254f"
        ),
    ],
