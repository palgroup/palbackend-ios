...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "Palbe",
            url: "https://github.com/palgroup/palbackend-ios/releases/download/v0.5.1/Palbe.xcframework.zip",
            checksum: "2a7cdef43b353c105af078335add9f3d8c21835ab78b71e2b39e08432ffea751"
        ),
    ],
